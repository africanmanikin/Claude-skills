...
class GranolaMCPServer:
    ...
    def _get_default_cache_path(self) -> str:
        """Get the default Granola cache path based on the operating system."""
        ...
        if system == "Darwin":  # macOS
            ...
            if appdata:
                cache_path = os.path.join(appdata, "Granola", "cache-v3.json")
                if os.path.exists(cache_path):
                    return cache_path

            localappdata = os.getenv("LOCALAPPDATA")
            if localappdata:
                return os.path.join(localappdata, "Granola", "cache-v3.json")

            # Fallback for Windows
            return os.path.join(os.path.expanduser("~"), "AppData", "Roaming", "Granola", "cache-v3.json")
        else:  # Linux or other
            return os.path.expanduser("~/.local/share/Granola/cache-v3.json")
    ...
    def _detect_local_timezone(self):
        ...
        # Ultimate fallback to Eastern Time
